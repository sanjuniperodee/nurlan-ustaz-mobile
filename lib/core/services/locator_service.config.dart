...
import '../../features/app/bloc/app_bloc.dart' as _i25;
import '../../features/app/bloc/other_list_bloc/language_cubit.dart' as _i17;
...
import '../../features/auth/data/repositories/auth_repository.dart' as _i13;
import '../../features/auth/presentation/bloc/auth_cubit.dart' as _i26;
import '../../features/auth/presentation/bloc/code_verification_cubit.dart'
    as _i14;
import '../../features/auth/presentation/bloc/login_cubit.dart' as _i18;
import '../../features/auth/presentation/bloc/registration_cubit.dart' as _i22;
import '../../features/home/data/datasource/remote/home_remote_ds.dart' as _i7;
import '../../features/home/data/repositories/home_repository.dart' as _i15;
import '../../features/home/presentation/bloc/news_cubit.dart' as _i20;
...
import '../platform/network_info.dart' as _i10;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.HomeRemoteDs>(
        () => _i7.HomeRemoteDsImpl(gh<_i6.DioWrapper>()));
    ...
    gh.singleton<_i10.NetworkInfo>(
        _i10.NetworkInfoImp(gh<_i11.InternetConnectionChecker>()));
    gh.singleton<_i12.NotAuthLogic>(_i12.NotAuthLogic());
    gh.singleton<_i13.AuthRepository>(_i13.AuthRepositoryImpl(
      networkInfo: gh<_i10.NetworkInfo>(),
      remoteDS: gh<_i5.AuthRemoteDs>(),
      localDS: gh<_i3.AuthLocalDs>(),
    ));
    gh.singleton<_i14.CodeVerificationCubit>(
        _i14.CodeVerificationCubit(gh<_i13.AuthRepository>()));
    gh.singleton<_i15.HomeRepository>(_i15.HomeRepositoryImpl(
      remoteDS: gh<_i7.HomeRemoteDs>(),
      networkInfo: gh<_i10.NetworkInfo>(),
    ));
    gh.singleton<_i16.IslamTeachingRepository>(_i16.IslamTeachingRepositoryImpl(
      remoteDS: gh<_i9.IslamTeachingRemoteDs>(),
      networkInfo: gh<_i10.NetworkInfo>(),
    ));
    gh.singleton<_i17.LanguageCubit>(
        _i17.LanguageCubit(gh<_i13.AuthRepository>()));
    gh.singleton<_i18.LoginCubit>(_i18.LoginCubit(gh<_i13.AuthRepository>()));
    gh.singleton<_i19.NamesOfAllahCubit>(
        _i19.NamesOfAllahCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i20.NewsCubit>(_i20.NewsCubit(gh<_i15.HomeRepository>()));
    gh.singleton<_i21.PillarsCubit>(
        _i21.PillarsCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i22.RegistrationCubit>(
        _i22.RegistrationCubit(gh<_i13.AuthRepository>()));
    gh.singleton<_i23.SurahCubit>(
        _i23.SurahCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i24.SurahFavoriteCubit>(
        _i24.SurahFavoriteCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i25.AppBloc>(_i25.AppBloc(
      gh<_i13.AuthRepository>(),
      gh<_i12.NotAuthLogic>(),
    ));

    gh.singleton<_i26.AuthCubit>(_i26.AuthCubit(gh<_i13.AuthRepository>()));
    gh.singleton<_i27.AyatOfDayCubit>(
        _i27.AyatOfDayCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i28.DhikrsCubit>(
        _i28.DhikrsCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i29.DhikrsFavoriteCubit>(
        _i29.DhikrsFavoriteCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i30.DuasCubit>(
        _i30.DuasCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i31.DuasFavoriteCubit>(
        _i31.DuasFavoriteCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i32.IslamNamesCubit>(
        _i32.IslamNamesCubit(gh<_i16.IslamTeachingRepository>()));
    gh.singleton<_i33.IslamNamesFavoriteCubit>(
        _i33.IslamNamesFavoriteCubit(gh<_i16.IslamTeachingRepository>()));
