...
_ResultHomeDTO _$ResultHomeDTOFromJson(Map<String, dynamic> json) =>
    _ResultHomeDTO(
      isLiked: json['is_liked'] as bool? ?? false,
      isSaved: json['is_saved'] as bool? ?? false,
      isLive: json['is_live'] as bool?,
      free: json['is_free'] as bool?,
      isPurchased: json['is_purchased'] as bool?,
      isTop: json['is_top'] as bool?,
      likesCount: (json['likes_count'] as num?)?.toInt(),
      comentCount: (json['comments_count'] as num?)?.toInt(),
      ticketUrl: json['ticket_url'] as String?,
      availableTicket: (json['available_tickets'] as num?)?.toInt(),
...
Map<String, dynamic> _$ResultHomeDTOToJson(_ResultHomeDTO instance) =>
    <String, dynamic>{
      'is_liked': instance.isLiked,
      'is_saved': instance.isSaved,
      'is_live': instance.isLive,
      'is_free': instance.free,
      ...
      'available_tickets': instance.availableTicket,
      'id': instance.id,
