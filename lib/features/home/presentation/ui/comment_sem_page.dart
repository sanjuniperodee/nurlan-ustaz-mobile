...
@RoutePage()
class CommentSemPage extends StatefulWidget {
  final int id;
  const CommentSemPage({super.key, required this.id});

  @override
  State<CommentSemPage> createState() => _CommentSemPageState();
}

class _CommentSemPageState extends State<CommentSemPage> {
