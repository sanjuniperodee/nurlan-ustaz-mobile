...
import 'package:nurlan_ustaz_flutter/features/home/presentation/ui/ustaz_aitinizhi/presentation/widgets/custom_calendar_event.dart';
...
class CustomCalendarChatTile extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: isSelected && date != null
                ? BoxDecoration(color: AppColors.orange, shape: BoxShape.circle)
                : daysWithChat!.contains(date)
                    ? BoxDecoration(
