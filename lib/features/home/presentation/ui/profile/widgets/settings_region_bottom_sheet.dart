...
class _RegionSettingsBottomSheetState extends State<RegionSettingsBottomSheet> {
  @override
  Widget build(BuildContext context) {
    final List<String> regions =
        List.generate(40, (index) => 'Город ${index + 1}');
    return Container(
                    ...
                    children: [
                      Text(
                        ...
                        style: getTextStyle(CustomTextStyles.s16w400)
                            .apply(fontFamily: FontTypes.SFPro.name),
                      ),
                      GestureDetector(
                          onTap: () {
                            setState(() {
