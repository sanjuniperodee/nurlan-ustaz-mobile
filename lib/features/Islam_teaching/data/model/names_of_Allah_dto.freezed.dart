...
/// @nodoc
abstract class $NamesOfAllahDTOCopyWith<$Res> {
  factory $NamesOfAllahDTOCopyWith(
          NamesOfAllahDTO value, $Res Function(NamesOfAllahDTO) then) =
      _$NamesOfAllahDTOCopyWithImpl<$Res, NamesOfAllahDTO>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$NamesOfAllahDTOCopyWithImpl<$Res, $Val extends NamesOfAllahDTO>
    implements $NamesOfAllahDTOCopyWith<$Res> {
  _$NamesOfAllahDTOCopyWithImpl(this._value, this._then);
...
abstract class _NamesOfAllahDTO implements NamesOfAllahDTO {
  const factory _NamesOfAllahDTO(
