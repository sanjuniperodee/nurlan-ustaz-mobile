...
import 'custom_agenda_controller.dart';
import 'custom_type_data.dart';

class CustomCalendarAgenda extends StatefulWidget
    implements PreferredSizeWidget {
  final CustomCalendarAgendaController? controller;
...
class CustomCalendarAgendaState extends State<CustomCalendarAgenda>
  ...
  Widget build(BuildContext context) {
    backgroundColor = AppColors.white.withOpacity(0.000000009);
  ...
  _initCalendar() {
    if (widget.controller != null &&
        widget.controller is CustomCalendarAgendaController) {
