      ...
      decoration: InputDecoration(
        suffixIcon: obscureText != null
            ? IconButton(
                ...
                icon: obscureText!
                    ? SvgPicture.asset('assets/icons/obscure-off.svg')
                    : SvgPicture.asset('assets/icons/obscure.svg'))
            : null,
        helperText: helperText,
        helperStyle: getTextStyle(CustomTextStyles.s12w400)
            .copyWith(fontFamily: FontTypes.SFPro.name, color: helperColor),
        errorText: errorText,
        label: Text(
          labelText,
        ...
        hintStyle: getTextStyle(CustomTextStyles.s12w400)
            .copyWith(fontFamily: FontTypes.SFPro.name, color: AppColors.grey1),
